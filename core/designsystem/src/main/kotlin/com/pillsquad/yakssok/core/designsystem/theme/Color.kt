...
object WidgetColor {
    ...
    val grey200 = Color(0xFFDCDCDC)
    val grey300 = Color(0xFFBDBDBD)
    val grey400 = Color(0xFF989898)
    val grey500 = Color(0xFF7C7C7C)
    val grey600 = Color(0xFF656565)
    val grey700 = Color(0xFF525252)
    val grey800 = Color(0xFF464646)
    val grey900 = Color(0xFF3D3D3D)
    val grey950 = Color(0xFF202020)
    val primary50 = Color(0xFFFFF2ED)
    val primary100 = Color(0xFFFFE3D6)
    val primary200 = Color(0xFFFDC2AB)
    val primary300 = Color(0xFFFB9876)
    val primary400 = Color(0xFFF9623E)
    val primary500 = Color(0xFFF63A18)
    val primary600 = Color(0xFFE7220F)
    val primary700 = Color(0xFFC0140E)
    val primary800 = Color(0xFF981415)
    val primary900 = Color(0xFF7B1313)
    val primary950 = Color(0xFF42080B)
    val subPurple = Color(0xFF7C24DB)
    val subYellow = Color(0xFFFFB012)
